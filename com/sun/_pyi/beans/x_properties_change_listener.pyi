...
class XPropertiesChangeListener(XEventListener_c7230c4a):
    """
    ...
    """
    __pyunointerface__: Literal['com.sun.star.beans.XPropertiesChangeListener']

    def propertiesChange(self, aEvent: 'typing.Tuple[PropertyChangeEvent_1b180ebe, ...]') -> None:
        """
        gets called when bound properties are changed.
        """

__all__ = ['XPropertiesChangeListener']
