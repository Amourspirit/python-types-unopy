...
if typing.TYPE_CHECKING:
    from .print_job_event import PrintJobEvent as PrintJobEvent_bcd60bed

class XPrintJobListener(XEventListener_c7230c4a):
    """
    ...
    **since**
    ...
    """
    __pyunointerface__: Literal['com.sun.star.view.XPrintJobListener']

    def printJobEvent(self, Event: 'PrintJobEvent_bcd60bed') -> None:
        """
        informs the user about the creation or the progress of a PrintJob
        """

__all__ = ['XPrintJobListener']
