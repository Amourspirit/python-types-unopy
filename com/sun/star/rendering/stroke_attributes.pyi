...
class StrokeAttributes(object):
    ...
    def __init__(self, StrokeWidth: typing.Optional[float] = ..., MiterLimit: typing.Optional[float] = ..., DashArray: typing.Optional[typing.Tuple[float, ...]] = ..., LineArray: typing.Optional[typing.Tuple[float, ...]] = ..., StartCapType: typing.Optional[int] = ..., EndCapType: typing.Optional[int] = ..., JoinType: typing.Optional[int] = ...) -> None:
        """
        Constructor
