...
class RenderState(object):
    ...
    **since**
    ...
    def __init__(self, AffineTransform: typing.Optional[AffineMatrix2D_ff040da8] = ..., Clip: typing.Optional[XPolyPolygon2D_e1b0e20] = ..., DeviceColor: typing.Optional[typing.Tuple[ColorComponent_e4c0e78, ...]] = ..., CompositeOperation: typing.Optional[int] = ...) -> None:
        """
        Constructor
