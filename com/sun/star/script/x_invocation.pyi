...
class XInvocation(XInterface_8f010a43):
    ...
    def getIntrospection(self) -> XIntrospectionAccess_2a050f2c:
        ...
        """
        ...
    def getValue(self, aPropertyName: str) -> typing.Any:
        """
    ...
    def hasProperty(self, aName: str) -> bool:
        ...
        This optimizes the calling sequence ( XInvocation.hasProperty(), XInvocation.getValue() ) or
    ...
    def invoke(self, aFunctionName: str, aParams: typing.Tuple[object, ...], aOutParamIndex: typing.Tuple[int, ...], aOutParam: typing.Tuple[object, ...]) -> typing.Any:
        ...
        * ``aOutParam`` is an out direction argument.
        ...
        """
        ...
    def setValue(self, aPropertyName: str, aValue: typing.Any) -> None:
        """
