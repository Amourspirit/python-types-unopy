...
class AllEventObject(EventObject_a3d70b03):
    ...
    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = ..., Helper: typing.Optional[object] = ..., ListenerType: typing.Optional[object] = ..., MethodName: typing.Optional[str] = ..., Arguments: typing.Optional[typing.Tuple[object, ...]] = ...) -> None:
        """
        Constructor
