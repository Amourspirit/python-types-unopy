...
class ContextInformation(object):
    ...
    def __init__(self, Name: typing.Optional[str] = ..., SourceCode: typing.Optional[str] = ..., StartLine: typing.Optional[int] = ..., StartColumn: typing.Optional[int] = ..., EndLine: typing.Optional[int] = ..., EndColumn: typing.Optional[int] = ..., LocalVariableNames: typing.Optional[typing.Tuple[str, ...]] = ...) -> None:
        """
        Constructor
