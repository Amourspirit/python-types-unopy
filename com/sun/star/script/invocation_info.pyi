...
class InvocationInfo(object):
    ...
    def __init__(self, aName: typing.Optional[str] = ..., eMemberType: typing.Optional[MemberType_b1e00b97] = ..., PropertyAttribute: typing.Optional[int] = ..., aType: typing.Optional[object] = ..., aParamTypes: typing.Optional[typing.Tuple[object, ...]] = ..., aParamModes: typing.Optional[typing.Tuple[ParamMode_d7260ca9, ...]] = ...) -> None:
        """
        Constructor
