...
class XPropertyHandler(XComponent_98dc0ab5):
    ...
    **since**
    ...
    def isComposable(self, PropertyName: str) -> bool:
        ...
        """
        ...
    def onInteractivePropertySelection(self, PropertyName: str, Primary: bool, outData: typing.Any, InspectorUI: XObjectInspectorUI_5ccd1048) -> InteractiveSelectionResultProto:
        """
