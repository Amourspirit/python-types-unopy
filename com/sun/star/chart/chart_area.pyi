...
class ChartArea(FillProperties_f1200da8, LineProperties_f13f0da9, UserDefinedAttributesSupplier_9fbe1222, XPropertySet_bc180bfa):
    """
    Service Class

    Specifies the area elements of a chart, e.g.
    
    the background area, the diagram wall, and the diagram floor of three-dimensional charts.
