...
class XMasterPageTarget(XInterface_8f010a43):
    """
    is implemented by objects that can be linked to a MasterPage.

    See Also:
        `API XMasterPageTarget <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1drawing_1_1XMasterPageTarget.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.drawing.XMasterPageTarget']
