...
class GraphicFilterRequest(Exception_85530a09):
    """
    Exception Class
    ...
    **since**
    ...
    See Also:
        `API GraphicFilterRequest <https://api.libreoffice.org/docs/idl/ref/exceptioncom_1_1sun_1_1star_1_1drawing_1_1GraphicFilterRequest.html>`_
    """

    typeName: Literal['com.sun.star.drawing.GraphicFilterRequest']
