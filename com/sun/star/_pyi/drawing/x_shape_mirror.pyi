...
if typing.TYPE_CHECKING:
    from .mirror_axis import MirrorAxis as MirrorAxis_bdcf0c04
...
class XShapeMirror(XInterface_8f010a43):
    ...
    """
    __pyunointerface__: Literal['com.sun.star.drawing.XShapeMirror']

    def mirror(self, aShapes: typing.Any, eAxis: 'MirrorAxis_bdcf0c04') -> None:
        """
        mirrors the given Shapes at the given axis.
        """
        ...
    def mirrorAtAxis(self, aShapes: typing.Any, aLine: 'XShape_8fd00a3d') -> None:
        """
        mirrors the given Shapes at the given axis.
        """
        ...
