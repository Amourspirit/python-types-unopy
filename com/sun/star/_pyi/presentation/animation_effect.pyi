...
class AnimationEffect(Enum):
    ...
    """
    HORIZONTAL_ROTATE: Literal['HORIZONTAL_ROTATE']
    """
    use the animation effect \"Horizontal Rotate\".
    """
    HORIZONTAL_STRETCH: Literal['HORIZONTAL_STRETCH']
    """
    ...
    """
    LASER_FROM_BOTTOM: Literal['LASER_FROM_BOTTOM']
    """
    use the animation effect \"Laser from Bottom\".
    """
    LASER_FROM_LEFT: Literal['LASER_FROM_LEFT']
    """
    use the animation effect \"Wavy Line from Left\".
    """
    LASER_FROM_LOWERLEFT: Literal['LASER_FROM_LOWERLEFT']
    """
    use the animation effect \"Laser from Lower Left\".
    """
    LASER_FROM_LOWERRIGHT: Literal['LASER_FROM_LOWERRIGHT']
    """
    use the animation effect \"Laser from Lower Right\".
    """
    LASER_FROM_RIGHT: Literal['LASER_FROM_RIGHT']
    """
    use the animation effect \"Laser from Right\".
    """
    LASER_FROM_TOP: Literal['LASER_FROM_TOP']
    """
    use the animation effect \"Laser from Top\".
    """
    LASER_FROM_UPPERLEFT: Literal['LASER_FROM_UPPERLEFT']
    """
    use the animation effect \"Laser from Upper Left\".
    """
    LASER_FROM_UPPERRIGHT: Literal['LASER_FROM_UPPERRIGHT']
    """
    ...
    """
    MOVE_SHORT_FROM_BOTTOM: Literal['MOVE_SHORT_FROM_BOTTOM']
    """
    use the animation effect \"Move Short from Bottom\".
    """
    MOVE_SHORT_FROM_LEFT: Literal['MOVE_SHORT_FROM_LEFT']
    """
    use the animation effect \"Move Short from Left\".
    """
    MOVE_SHORT_FROM_LOWERLEFT: Literal['MOVE_SHORT_FROM_LOWERLEFT']
    """
    use the animation effect \"Move Short from Lower Left\".
    """
    MOVE_SHORT_FROM_LOWERRIGHT: Literal['MOVE_SHORT_FROM_LOWERRIGHT']
    """
    use the animation effect \"Move Short from Lower Right\".
    """
    MOVE_SHORT_FROM_RIGHT: Literal['MOVE_SHORT_FROM_RIGHT']
    """
    use the animation effect \"Move Short from Right\".
    """
    MOVE_SHORT_FROM_TOP: Literal['MOVE_SHORT_FROM_TOP']
    """
    use the animation effect \"Move Short from Top\".
    """
    MOVE_SHORT_FROM_UPPERLEFT: Literal['MOVE_SHORT_FROM_UPPERLEFT']
    """
    use the animation effect \"Move Short from Upper Left\".
    """
    MOVE_SHORT_FROM_UPPERRIGHT: Literal['MOVE_SHORT_FROM_UPPERRIGHT']
    """
    use the animation effect \"Move Short from Upper Right\".
    """
    MOVE_SHORT_TO_BOTTOM: Literal['MOVE_SHORT_TO_BOTTOM']
    """
    use the animation effect \"Move Short to Bottom\".
    """
    MOVE_SHORT_TO_LEFT: Literal['MOVE_SHORT_TO_LEFT']
    """
    use the animation effect \"Move Short to Left\".
    """
    MOVE_SHORT_TO_LOWERLEFT: Literal['MOVE_SHORT_TO_LOWERLEFT']
    """
    use the animation effect \"Move Short to Lower Left\".
    """
    MOVE_SHORT_TO_LOWERRIGHT: Literal['MOVE_SHORT_TO_LOWERRIGHT']
    """
    use the animation effect \"Move Short to Lower Right\".
    """
    MOVE_SHORT_TO_RIGHT: Literal['MOVE_SHORT_TO_RIGHT']
    """
    use the animation effect \"Move Short to Right\".
    """
    MOVE_SHORT_TO_TOP: Literal['MOVE_SHORT_TO_TOP']
    """
    use the animation effect \"Move Short to Top\".
    """
    MOVE_SHORT_TO_UPPERLEFT: Literal['MOVE_SHORT_TO_UPPERLEFT']
    """
    use the animation effect \"Move Short to Upper Left\".
    """
    MOVE_SHORT_TO_UPPERRIGHT: Literal['MOVE_SHORT_TO_UPPERRIGHT']
    """
    use the animation effect \"Move Short to Upper Right\".
    """
    MOVE_TO_BOTTOM: Literal['MOVE_TO_BOTTOM']
    """
    use the animation effect \"Move to Bottom\".
    """
    MOVE_TO_LEFT: Literal['MOVE_TO_LEFT']
    """
    use the animation effect \"Move to Left\".
    """
    MOVE_TO_LOWERLEFT: Literal['MOVE_TO_LOWERLEFT']
    """
    use the animation effect \"Move to Lower Left\".
    """
    MOVE_TO_LOWERRIGHT: Literal['MOVE_TO_LOWERRIGHT']
    """
    use the animation effect \"Move to Lower Right\".
    """
    MOVE_TO_RIGHT: Literal['MOVE_TO_RIGHT']
    """
    use the animation effect \"Move to Right\".
    """
    MOVE_TO_TOP: Literal['MOVE_TO_TOP']
    """
    use the animation effect \"Move to Top\".
    """
    MOVE_TO_UPPERLEFT: Literal['MOVE_TO_UPPERLEFT']
    """
    use the animation effect \"Move to Upper Left\".
    """
    MOVE_TO_UPPERRIGHT: Literal['MOVE_TO_UPPERRIGHT']
    """
    ...
    """
    STRETCH_FROM_LOWERLEFT: Literal['STRETCH_FROM_LOWERLEFT']
    """
    use the animation effect \"Stretch From Lower Left\".
    """
    STRETCH_FROM_LOWERRIGHT: Literal['STRETCH_FROM_LOWERRIGHT']
    """
    ...
    """
    STRETCH_FROM_UPPERLEFT: Literal['STRETCH_FROM_UPPERLEFT']
    """
    use the animation effect \"Stretch From Upper Left\".
    """
    STRETCH_FROM_UPPERRIGHT: Literal['STRETCH_FROM_UPPERRIGHT']
    """
    ...
    """
    VERTICAL_ROTATE: Literal['VERTICAL_ROTATE']
    """
    use the animation effect \"Vertical Rotate\".
    """
    VERTICAL_STRETCH: Literal['VERTICAL_STRETCH']
    """
    ...
    """
    ZOOM_IN: Literal['ZOOM_IN']
    """
    use the animation effect \"Zoom In\".
    """
    ZOOM_IN_FROM_BOTTOM: Literal['ZOOM_IN_FROM_BOTTOM']
    """
    use the animation effect \"Zoom In From Bottom\".
    """
    ZOOM_IN_FROM_CENTER: Literal['ZOOM_IN_FROM_CENTER']
    """
    use the animation effect \"Zoom In From Center\".
    """
    ZOOM_IN_FROM_LEFT: Literal['ZOOM_IN_FROM_LEFT']
    """
    use the animation effect \"Zoom In From Left\".
    """
    ZOOM_IN_FROM_LOWERLEFT: Literal['ZOOM_IN_FROM_LOWERLEFT']
    """
    use the animation effect \"Zoom In From Lower Left\".
    """
    ZOOM_IN_FROM_LOWERRIGHT: Literal['ZOOM_IN_FROM_LOWERRIGHT']
    """
    use the animation effect \"Zoom In From Lower Right\".
    """
    ZOOM_IN_FROM_RIGHT: Literal['ZOOM_IN_FROM_RIGHT']
    """
    use the animation effect \"Zoom In From Right\".
    """
    ZOOM_IN_FROM_TOP: Literal['ZOOM_IN_FROM_TOP']
    """
    use the animation effect \"Zoom In From Top\".
    """
    ZOOM_IN_FROM_UPPERLEFT: Literal['ZOOM_IN_FROM_UPPERLEFT']
    """
    use the animation effect \"Zoom In From Upper Left\".
    """
    ZOOM_IN_FROM_UPPERRIGHT: Literal['ZOOM_IN_FROM_UPPERRIGHT']
    """
    use the animation effect \"Zoom In From Upper Right\".
    """
    ZOOM_IN_SMALL: Literal['ZOOM_IN_SMALL']
    """
    use the animation effect \"Zoom In Small\".
    """
    ZOOM_IN_SPIRAL: Literal['ZOOM_IN_SPIRAL']
    """
    use the animation effect \"Zoom In Spiral\".
    """
    ZOOM_OUT: Literal['ZOOM_OUT']
    """
    use the animation effect \"Zoom Out\".
    """
    ZOOM_OUT_FROM_BOTTOM: Literal['ZOOM_OUT_FROM_BOTTOM']
    """
    use the animation effect \"Zoom Out From Bottom\".
    """
    ZOOM_OUT_FROM_CENTER: Literal['ZOOM_OUT_FROM_CENTER']
    """
    use the animation effect \"Zoom Out From Center\".
    """
    ZOOM_OUT_FROM_LEFT: Literal['ZOOM_OUT_FROM_LEFT']
    """
    use the animation effect \"Zoom Out From Left\".
    """
    ZOOM_OUT_FROM_LOWERLEFT: Literal['ZOOM_OUT_FROM_LOWERLEFT']
    """
    use the animation effect \"Zoom Out From Lower Left\".
    """
    ZOOM_OUT_FROM_LOWERRIGHT: Literal['ZOOM_OUT_FROM_LOWERRIGHT']
    """
    use the animation effect \"Zoom Out From Lower Right\".
    """
    ZOOM_OUT_FROM_RIGHT: Literal['ZOOM_OUT_FROM_RIGHT']
    """
    use the animation effect \"Zoom Out From Right\".
    """
    ZOOM_OUT_FROM_TOP: Literal['ZOOM_OUT_FROM_TOP']
    """
    use the animation effect \"Zoom Out From Top\".
    """
    ZOOM_OUT_FROM_UPPERLEFT: Literal['ZOOM_OUT_FROM_UPPERLEFT']
    """
    use the animation effect \"Zoom Out From Upper Left\".
    """
    ZOOM_OUT_FROM_UPPERRIGHT: Literal['ZOOM_OUT_FROM_UPPERRIGHT']
    """
    use the animation effect \"Zoom Out From Upper Right\".
    """
    ZOOM_OUT_SMALL: Literal['ZOOM_OUT_SMALL']
    """
    use the animation effect \"Zoom Out Small\".
    """
    ZOOM_OUT_SPIRAL: Literal['ZOOM_OUT_SPIRAL']
    """
