...
class XTableCharts(XNameAccess_e2ab0cf6):
    """
    provides methods to access charts via name and to insert and remove charts.

    See Also:
        `API XTableCharts <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1table_1_1XTableCharts.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.table.XTableCharts']

    def addNewByName(self, aName: str, aRect: 'Rectangle_84b109e9', aRanges: 'typing.Tuple[CellRangeAddress_ec450d43, ...]', bColumnHeaders: bool, bRowHeaders: bool) -> None:
        """
