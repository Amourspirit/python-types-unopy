...
class DatabaseParameterEvent(EventObject_a3d70b03):
    ...
    """
    typeName: Literal['com.sun.star.form.DatabaseParameterEvent']

    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = ..., Parameters: typing.Optional[XIndexAccess_f0910d6d] = ...) -> None:
        """
        Constructor
