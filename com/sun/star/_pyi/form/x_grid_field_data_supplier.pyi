...
class XGridFieldDataSupplier(XInterface_8f010a43):
    ...
    """
    __pyunointerface__: Literal['com.sun.star.form.XGridFieldDataSupplier']

    def queryFieldData(self, nRow: int, xType: typing.Any) -> 'typing.Tuple[object, ...]':
        """
        ...
        """
        ...
    def queryFieldDataType(self, xType: typing.Any) -> 'typing.Tuple[bool, ...]':
        """
