...
class DatabaseDeleteEvent(EventObject_a3d70b03):
    ...
    """
    typeName: Literal['com.sun.star.form.DatabaseDeleteEvent']

    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = ..., Bookmarks: typing.Optional[typing.Tuple[object, ...]] = ...) -> None:
        """
        Constructor
