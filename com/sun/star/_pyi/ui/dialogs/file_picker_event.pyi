...
class FilePickerEvent(EventObject_a3d70b03):
    ...
    """
    typeName: Literal['com.sun.star.ui.dialogs.FilePickerEvent']

    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = ..., ElementId: typing.Optional[int] = ...) -> None:
        """
        Constructor
