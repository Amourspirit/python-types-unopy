...
class ContextChangeEventObject(EventObject_a3d70b03):
    ...
    """
    typeName: Literal['com.sun.star.ui.ContextChangeEventObject']

    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = ..., ApplicationName: typing.Optional[str] = ..., ContextName: typing.Optional[str] = ...) -> None:
        """
        Constructor
