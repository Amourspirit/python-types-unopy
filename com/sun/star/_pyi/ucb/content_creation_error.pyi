...
class ContentCreationError(Enum):
    ...
    """
    CONTENT_CREATION_FAILED: Literal['CONTENT_CREATION_FAILED']
    """
    Provider was unable to create the content instance.
    """
    IDENTIFIER_CREATION_FAILED: Literal['IDENTIFIER_CREATION_FAILED']
    """
    Creation of content identifier failed.
    """
    NO_CONTENT_BROKER: Literal['NO_CONTENT_BROKER']
    """
    """
    NO_CONTENT_PROVIDER: Literal['NO_CONTENT_PROVIDER']
    """
    No Content Provider for given content identifier available.
    """
    NO_IDENTIFIER_FACTORY: Literal['NO_IDENTIFIER_FACTORY']
    """
    """
