...
class UnsupportedOpenModeException(Exception_85530a09):
    ...
    typeName: Literal['com.sun.star.ucb.UnsupportedOpenModeException']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., Mode: typing.Optional[int] = ...) -> None:
        """
        Constructor
