...
class XCommandProcessor(XInterface_8f010a43):
    ...
    """
    __pyunointerface__: Literal['com.sun.star.ucb.XCommandProcessor']
    ...
    def createCommandIdentifier(self) -> int:
        ...
        """
        ...
    def execute(self, aCommand: 'Command_709c0901', CommandId: int, Environment: 'XCommandEnvironment_fb330dee') -> typing.Any:
        """
        executes a command.
