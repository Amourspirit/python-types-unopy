...
class InteractiveNetworkReadException(InteractiveNetworkException_7ca31159):
    """
    Exception Class
    ...
    See Also:
        `API InteractiveNetworkReadException <https://api.libreoffice.org/docs/idl/ref/exceptioncom_1_1sun_1_1star_1_1ucb_1_1InteractiveNetworkReadException.html>`_
    """

    typeName: Literal['com.sun.star.ucb.InteractiveNetworkReadException']
...
__all__ = ['InteractiveNetworkReadException']
