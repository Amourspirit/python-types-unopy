...
class ContentCreationException(Exception_85530a09):
    ...
    typeName: Literal['com.sun.star.ucb.ContentCreationException']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., eError: typing.Optional[ContentCreationError_b010e5c] = ...) -> None:
        """
        Constructor
