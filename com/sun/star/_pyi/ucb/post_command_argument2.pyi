...
class PostCommandArgument2(PostCommandArgument_fc590dea):
    ...
    """
    typeName: Literal['com.sun.star.ucb.PostCommandArgument2']

    def __init__(self, Source: typing.Optional[XInputStream_98d40ab4] = ..., Sink: typing.Optional[XInterface_8f010a43] = ..., MediaType: typing.Optional[str] = ..., Referer: typing.Optional[str] = ...) -> None:
        """
        Constructor
