...
class FontRequest(object):
    ...
    **since**
    ...
    """
    typeName: Literal['com.sun.star.rendering.FontRequest']

    def __init__(self, FontDescription: typing.Optional[FontInfo_bded0be9] = ..., CellSize: typing.Optional[float] = ..., ReferenceAdvancement: typing.Optional[float] = ..., Locale: typing.Optional[Locale_70d308fa] = ...) -> None:
        """
        Constructor
