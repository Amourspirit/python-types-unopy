...
class XStringRepresentation(ABC):
    ...
    """
    __pyunointerface__: Literal['com.sun.star.inspection.XStringRepresentation']

    def convertToControlValue(self, PropertyValue: typing.Any) -> str:
        """
        ...
        """
        ...
    def convertToPropertyValue(self, ControlValue: str, ControlValueType: typing.Any) -> typing.Any:
        """
