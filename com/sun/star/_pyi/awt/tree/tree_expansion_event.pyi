...
class TreeExpansionEvent(EventObject_a3d70b03):
    ...
    """
    typeName: Literal['com.sun.star.awt.tree.TreeExpansionEvent']

    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = ..., Node: typing.Optional[XTreeNode_baaf0ba0] = ...) -> None:
        """
        Constructor
