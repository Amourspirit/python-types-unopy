...
class TabPageActivatedEvent(EventObject_a3d70b03):
    ...
    **since**
    ...
    """
    typeName: Literal['com.sun.star.awt.tab.TabPageActivatedEvent']

    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = ..., TabPageID: typing.Optional[int] = ...) -> None:
        """
        Constructor
