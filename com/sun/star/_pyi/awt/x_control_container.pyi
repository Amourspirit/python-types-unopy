...
class XControlContainer(XInterface_8f010a43):
    """
    Provides access to the controls within an UnoControlContainer.

    See Also:
        `API XControlContainer <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1awt_1_1XControlContainer.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.awt.XControlContainer']

    def addControl(self, Name: str, Control: 'XControl_7a9c098d') -> None:
        """
