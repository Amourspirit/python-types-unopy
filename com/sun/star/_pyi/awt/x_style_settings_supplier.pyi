...
class XStyleSettingsSupplier(ABC):
    """
    provides access to the style settings of a component

    See Also:
        `API XStyleSettingsSupplier <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1awt_1_1XStyleSettingsSupplier.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.awt.XStyleSettingsSupplier']
