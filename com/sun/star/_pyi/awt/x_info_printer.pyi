...
class XInfoPrinter(XPrinterPropertySet_ff190e21):
    """
    represents an information printer.

    See Also:
        `API XInfoPrinter <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1awt_1_1XInfoPrinter.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.awt.XInfoPrinter']

    def createDevice(self) -> 'XDevice_70ba08fc':
        """
