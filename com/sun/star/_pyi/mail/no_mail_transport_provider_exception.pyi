...
class NoMailTransportProviderException(MailException_ba9e0bdd):
    """
    Exception Class
    ...
    **since**
    ...
    See Also:
        `API NoMailTransportProviderException <https://api.libreoffice.org/docs/idl/ref/exceptioncom_1_1sun_1_1star_1_1mail_1_1NoMailTransportProviderException.html>`_
    """

    typeName: Literal['com.sun.star.mail.NoMailTransportProviderException']
