...
class MissingJavaRuntimeException(JavaInitializationException_8b6211a3):
    ...
    **since**
    ...
    typeName: Literal['com.sun.star.java.MissingJavaRuntimeException']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., URLRuntimeLib: typing.Optional[str] = ...) -> None:
        """
        Constructor
