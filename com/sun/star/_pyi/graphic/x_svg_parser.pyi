...
class XSvgParser(XInterface_8f010a43):
    ...
    **since**
    ...
    """
    __pyunointerface__: Literal['com.sun.star.graphic.XSvgParser']

    def getDecomposition(self, xSvgStream: typing.Any, aAbsolutePath: str) -> 'typing.Tuple[XPrimitive2D_d5730c6d, ...]':
        """
        Retrieve decomposed list of simpler primitives.
        """
        ...
    def getDrawCommands(self, xSvgStream: typing.Any, aAbsolutePath: str) -> typing.Any:
        """
