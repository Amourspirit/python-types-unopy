...
class XDatabaseRanges(XNameAccess_e2ab0cf6):
    """
    provides functions to manage a collection of database ranges.

    See Also:
        `API XDatabaseRanges <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1sheet_1_1XDatabaseRanges.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.sheet.XDatabaseRanges']

    def addNewByName(self, aName: str, aRange: 'CellRangeAddress_ec450d43') -> None:
        """
