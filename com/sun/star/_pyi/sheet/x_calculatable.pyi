...
class XCalculatable(XInterface_8f010a43):
    """
    represents something that can recalculate.

    See Also:
        `API XCalculatable <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1sheet_1_1XCalculatable.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.sheet.XCalculatable']
