...
class DataPilotFieldSortInfo(object):
    ...
    """
    typeName: Literal['com.sun.star.sheet.DataPilotFieldSortInfo']

    def __init__(self, Field: typing.Optional[str] = ..., IsAscending: typing.Optional[bool] = ..., Mode: typing.Optional[int] = ...) -> None:
        """
        Constructor
