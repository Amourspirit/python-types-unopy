...
class XSheetAnnotation(XInterface_8f010a43):
    """
    provides methods to query data of the annotation and to show and hide it.

    See Also:
        `API XSheetAnnotation <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1sheet_1_1XSheetAnnotation.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.sheet.XSheetAnnotation']
