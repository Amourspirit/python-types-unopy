...
class ColorScaleEntryType(object):
    ...
    """
    COLORSCALE_MIN: Literal[0]
    COLORSCALE_MAX: Literal[1]
    COLORSCALE_PERCENTILE: Literal[2]
    COLORSCALE_VALUE: Literal[3]
    COLORSCALE_PERCENT: Literal[4]
    COLORSCALE_FORMULA: Literal[5]
