...
class FrameAction(Enum):
    ...
    """
    COMPONENT_ATTACHED: Literal['COMPONENT_ATTACHED']
    """
    ...
    """
    COMPONENT_DETACHING: Literal['COMPONENT_DETACHING']
    """
    ...
    """
    COMPONENT_REATTACHED: Literal['COMPONENT_REATTACHED']
    """
    ...
    """
    CONTEXT_CHANGED: Literal['CONTEXT_CHANGED']
    """
    ...
    """
    FRAME_ACTIVATED: Literal['FRAME_ACTIVATED']
    """
    ...
    """
    FRAME_DEACTIVATING: Literal['FRAME_DEACTIVATING']
    """
    ...
    """
    FRAME_UI_ACTIVATED: Literal['FRAME_UI_ACTIVATED']
    """
    an event of this kind is broadcast by an active frame when it is getting UI control (tool control).
    """
    FRAME_UI_DEACTIVATING: Literal['FRAME_UI_DEACTIVATING']
    """
