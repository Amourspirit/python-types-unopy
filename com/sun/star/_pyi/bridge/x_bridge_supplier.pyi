...
class XBridgeSupplier(XInterface_8f010a43):
    ...
    """
    __pyunointerface__: Literal['com.sun.star.bridge.XBridgeSupplier']

    def createBridge(self, modelDepObject: typing.Any, MachineId: 'Uik_4fac0783', ProcessId: int, sourceModelType: int, destModelType: int) -> typing.Any:
        """
