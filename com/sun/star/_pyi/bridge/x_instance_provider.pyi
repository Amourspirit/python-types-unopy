...
class XInstanceProvider(XInterface_8f010a43):
    """
    allows to export UNO objects to other processes.

    See Also:
        `API XInstanceProvider <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1bridge_1_1XInstanceProvider.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.bridge.XInstanceProvider']
