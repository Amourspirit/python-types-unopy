...
class ScriptFrameworkErrorException(Exception_85530a09):
    ...
    typeName: Literal['com.sun.star.script.provider.ScriptFrameworkErrorException']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., scriptName: typing.Optional[str] = ..., language: typing.Optional[str] = ..., errorType: typing.Optional[int] = ...) -> None:
        """
        Constructor
