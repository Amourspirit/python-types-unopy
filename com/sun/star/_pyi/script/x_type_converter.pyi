...
class XTypeConverter(XInterface_8f010a43):
    ...
    """
    __pyunointerface__: Literal['com.sun.star.script.XTypeConverter']

    def convertTo(self, aFrom: typing.Any, xDestinationType: typing.Any) -> typing.Any:
        """
        ...
        """
        ...
    def convertToSimpleType(self, aFrom: typing.Any, aDestinationType: 'TypeClass_853109f2') -> typing.Any:
        """
