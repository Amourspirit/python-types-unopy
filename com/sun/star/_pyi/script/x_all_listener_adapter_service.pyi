...
class XAllListenerAdapterService(XInterface_8f010a43):
    ...
    """
    __pyunointerface__: Literal['com.sun.star.script.XAllListenerAdapterService']

    def createAllListerAdapter(self, xListenerType: typing.Any, xListener: 'XAllListener_c91b0c54', aHelper: typing.Any) -> 'XInterface_8f010a43':
        """
