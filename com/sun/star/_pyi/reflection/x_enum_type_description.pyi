...
class XEnumTypeDescription(XTypeDescription_3c210fb1):
    ...
    See Also:
        `API XEnumTypeDescription <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1reflection_1_1XEnumTypeDescription.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.reflection.XEnumTypeDescription']

    def getDefaultEnumValue(self) -> int:
        """
