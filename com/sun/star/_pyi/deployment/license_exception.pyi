...
class LicenseException(Exception_85530a09):
    ...
    **since**
    ...
    typeName: Literal['com.sun.star.deployment.LicenseException']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., ExtensionName: typing.Optional[str] = ..., Text: typing.Optional[str] = ..., AcceptBy: typing.Optional[str] = ...) -> None:
        """
        Constructor
