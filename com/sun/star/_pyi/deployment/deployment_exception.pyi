...
class DeploymentException(Exception_85530a09):
    ...
    **since**
    ...
    typeName: Literal['com.sun.star.deployment.DeploymentException']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., Cause: typing.Optional[object] = ...) -> None:
        """
        Constructor
