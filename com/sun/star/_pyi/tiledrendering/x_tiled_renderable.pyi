...
class XTiledRenderable(XInterface_8f010a43):
    ...
    **since**
    ...
    """
    __pyunointerface__: Literal['com.sun.star.tiledrendering.XTiledRenderable']

    def paintTile(self, Parent: typing.Any, nOutputWidth: int, nOutputHeight: int, nTilePosX: int, nTilePosY: int, nTileWidth: int, nTileHeight: int) -> None:
        """
