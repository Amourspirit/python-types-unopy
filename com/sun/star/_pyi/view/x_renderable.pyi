...
class XRenderable(XInterface_8f010a43):
    ...
    **since**
    ...
    """
    __pyunointerface__: Literal['com.sun.star.view.XRenderable']

    def getRenderer(self, nRenderer: int, aSelection: typing.Any, xOptions: 'typing.Tuple[PropertyValue_c9610c73, ...]') -> 'typing.Tuple[PropertyValue_c9610c73, ...]':
        """
        ...
        """
        ...
    def getRendererCount(self, aSelection: typing.Any, xOptions: 'typing.Tuple[PropertyValue_c9610c73, ...]') -> int:
        """
        ...
        """
        ...
    def render(self, nRenderer: int, aSelection: typing.Any, xOptions: 'typing.Tuple[PropertyValue_c9610c73, ...]') -> None:
        """
        renders the object.
