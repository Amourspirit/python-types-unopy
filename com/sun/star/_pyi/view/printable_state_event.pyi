...
class PrintableStateEvent(EventObject_a3d70b03):
    ...
    """
    typeName: Literal['com.sun.star.view.PrintableStateEvent']

    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = ..., State: typing.Optional[PrintableState_c9fb0c65] = ...) -> None:
        """
        Constructor
