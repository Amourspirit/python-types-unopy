...
if typing.TYPE_CHECKING:
    from .x_string_width import XStringWidth as XStringWidth_b1760b95

class XStringAbbreviation(XInterface_8f010a43):
    """
    ...
    See Also:
        `API XStringAbbreviation <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1util_1_1XStringAbbreviation.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.util.XStringAbbreviation']

    def abbreviateString(self, xStringWidth: 'XStringWidth_b1760b95', nWidth: int, aString: str) -> str:
        """
