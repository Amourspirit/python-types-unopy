...
class XModeSelector(XInterface_8f010a43):
    """
    is supported by objects which supply different modes.

    See Also:
        `API XModeSelector <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1util_1_1XModeSelector.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.util.XModeSelector']
