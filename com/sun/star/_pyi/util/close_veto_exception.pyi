...
class CloseVetoException(Exception_85530a09):
    ...
    See Also:
        `API CloseVetoException <https://api.libreoffice.org/docs/idl/ref/exceptioncom_1_1sun_1_1star_1_1util_1_1CloseVetoException.html>`_
    """

    typeName: Literal['com.sun.star.util.CloseVetoException']
