...
class XStringWidth(XInterface_8f010a43):
    """
    An interface that encapsulates the abstract notion of string width.

    See Also:
        `API XStringWidth <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1util_1_1XStringWidth.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.util.XStringWidth']

    def queryStringWidth(self, aString: str) -> int:
        """
