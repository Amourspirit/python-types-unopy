...
class XImportable(XInterface_8f010a43):
    """
    makes it possible to import files into the object.

    See Also:
        `API XImportable <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1util_1_1XImportable.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.util.XImportable']
