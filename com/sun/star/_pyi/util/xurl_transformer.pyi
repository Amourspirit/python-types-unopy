...
if typing.TYPE_CHECKING:
    from .url import URL as URL_57ad07b9


class XURLTransformer(XInterface_8f010a43):
    """
    supports parsing and assembling of URLs

    See Also:
        `API XURLTransformer <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1util_1_1XURLTransformer.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.util.XURLTransformer']

    def assemble(self, aURL: typing.Any) -> bool:
        """
    ...
    def getPresentation(self, aURL: 'URL_57ad07b9', bWithPassword: bool) -> str:
        ...
        """
        ...
    def parseSmart(self, aURL: typing.Any, sSmartProtocol: str) -> bool:
        """
        ...
        """
        ...
    def parseStrict(self, aURL: typing.Any) -> bool:
        """
