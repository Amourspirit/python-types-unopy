...
class ChangesEvent(EventObject_a3d70b03):
    ...
    """
    typeName: Literal['com.sun.star.util.ChangesEvent']

    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = ..., Base: typing.Optional[object] = ..., Changes: typing.Optional[ChangesSet_99de0aab] = ...) -> None:
        """
        Constructor
