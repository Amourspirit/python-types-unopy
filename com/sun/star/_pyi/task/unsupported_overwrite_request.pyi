...
class UnsupportedOverwriteRequest(ClassifiedInteractionRequest_9f72121b):
    """
    Exception Class
    ...
    **since**
    ...
    See Also:
        `API UnsupportedOverwriteRequest <https://api.libreoffice.org/docs/idl/ref/exceptioncom_1_1sun_1_1star_1_1task_1_1UnsupportedOverwriteRequest.html>`_
    """

    typeName: Literal['com.sun.star.task.UnsupportedOverwriteRequest']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., Classification: typing.Optional[InteractionClassification_6c4d10e7] = ..., Name: typing.Optional[str] = ...) -> None:
        """
        Constructor
