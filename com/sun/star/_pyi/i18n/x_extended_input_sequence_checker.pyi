...
class XExtendedInputSequenceChecker(XInputSequenceChecker_1eb00e9e):
    ...
    **since**
    ...
    """
    __pyunointerface__: Literal['com.sun.star.i18n.XExtendedInputSequenceChecker']

    def correctInputSequence(self, aText: typing.Any, nPos: int, cInputChar: str, nInputCheckMode: int) -> int:
        """
        """
        ...
