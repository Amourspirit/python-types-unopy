...
class SAXInvalidCharacterException(SAXException_d1a00c6e):
    ...
    typeName: Literal['com.sun.star.xml.sax.SAXInvalidCharacterException']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., WrappedException: typing.Optional[object] = ...) -> None:
        """
        Constructor
