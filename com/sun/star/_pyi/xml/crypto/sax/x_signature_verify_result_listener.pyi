...
class XSignatureVerifyResultListener(XInterface_8f010a43):
    ...
    """
    __pyunointerface__: Literal['com.sun.star.xml.crypto.sax.XSignatureVerifyResultListener']

    def signatureVerified(self, securityId: int, verifyResult: 'SecurityOperationStatus_b66e12b5') -> None:
        """
