...
class EventException(Exception_85530a09):
    ...
    typeName: Literal['com.sun.star.xml.dom.events.EventException']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., code: typing.Optional[int] = ...) -> None:
        """
        Constructor
