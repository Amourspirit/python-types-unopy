...
class Script(TextField_90260a56):
    """
    Service Class
    ...
    See Also:
        `API Script <https://api.libreoffice.org/docs/idl/ref/servicecom_1_1sun_1_1star_1_1text_1_1textfield_1_1Script.html>`_
    """
    @property
    ...
    def ScriptType(self) -> str:
        """
        contains the name of the script type (i.e.
