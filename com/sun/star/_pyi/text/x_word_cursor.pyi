...
class XWordCursor(XTextCursor_a60c0b48):
    """
    makes it possible to move a cursor word by word.

    See Also:
        `API XWordCursor <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1text_1_1XWordCursor.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.text.XWordCursor']

    def gotoEndOfWord(self, bExpand: bool) -> bool:
        """
