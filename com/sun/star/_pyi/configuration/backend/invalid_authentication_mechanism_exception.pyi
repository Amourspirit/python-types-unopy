...
class InvalidAuthenticationMechanismException(BackendSetupException_68ae15de):
    """
    Exception Class
    ...
    **since**
    ...
    See Also:
        `API InvalidAuthenticationMechanismException <https://api.libreoffice.org/docs/idl/ref/exceptioncom_1_1sun_1_1star_1_1configuration_1_1backend_1_1InvalidAuthenticationMechanismException.html>`_
    """

    typeName: Literal['com.sun.star.configuration.backend.InvalidAuthenticationMechanismException']
