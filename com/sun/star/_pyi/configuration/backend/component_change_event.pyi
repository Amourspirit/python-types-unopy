...
class ComponentChangeEvent(EventObject_a3d70b03):
    ...
    """
    typeName: Literal['com.sun.star.configuration.backend.ComponentChangeEvent']

    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = ..., Component: typing.Optional[str] = ...) -> None:
        """
        Constructor
