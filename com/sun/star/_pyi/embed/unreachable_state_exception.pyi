...
class UnreachableStateException(Exception_85530a09):
    ...
    typeName: Literal['com.sun.star.embed.UnreachableStateException']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., CurrentState: typing.Optional[int] = ..., NextState: typing.Optional[int] = ...) -> None:
        """
        Constructor
