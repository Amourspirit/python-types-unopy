...
class XInsertObjectDialog(XInterface_8f010a43):
    """
    allows to create and initialize a new embedded object using GUI dialog.

    See Also:
        `API XInsertObjectDialog <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1embed_1_1XInsertObjectDialog.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.embed.XInsertObjectDialog']

    def createInstanceByDialog(self, xStorage: 'XStorage_8e460a32', sEntName: str, lObjArgs: 'typing.Tuple[PropertyValue_c9610c73, ...]') -> 'InsertedObjectInfo_a0e0e26':
        """
