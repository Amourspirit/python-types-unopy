...
class XStream(XInterface_8f010a43):
    """
    offers read and write access to the same stream.

    See Also:
        `API XStream <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1io_1_1XStream.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.io.XStream']
