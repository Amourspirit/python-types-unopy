...
class XActiveDataSource(XInterface_8f010a43):
    """
    has to be implemented if the class should be able to write into an output stream.

    See Also:
        `API XActiveDataSource <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1io_1_1XActiveDataSource.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.io.XActiveDataSource']
