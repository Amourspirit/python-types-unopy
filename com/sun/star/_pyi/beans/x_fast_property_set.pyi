...
class XFastPropertySet(XInterface_8f010a43):
    ...
    """
    __pyunointerface__: Literal['com.sun.star.beans.XFastPropertySet']

    def getFastPropertyValue(self, nHandle: int) -> typing.Any:
        """
        ...
        """
        ...
    def setFastPropertyValue(self, nHandle: int, aValue: typing.Any) -> None:
        """
