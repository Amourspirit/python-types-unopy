...
class XPropertiesChangeNotifier(XInterface_8f010a43):
    """
    specifies a notifier for changed property values

    See Also:
        `API XPropertiesChangeNotifier <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1beans_1_1XPropertiesChangeNotifier.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.beans.XPropertiesChangeNotifier']

    def addPropertiesChangeListener(self, PropertyNames: 'typing.Tuple[str, ...]', Listener: 'XPropertiesChangeListener_7a7d1122') -> None:
        """
