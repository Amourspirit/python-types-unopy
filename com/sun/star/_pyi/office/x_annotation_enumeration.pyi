...
class XAnnotationEnumeration(ABC):
    """
    An enumeration for a set of annotations.

    See Also:
        `API XAnnotationEnumeration <https://api.libreoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1office_1_1XAnnotationEnumeration.html>`_
    """
    __pyunointerface__: Literal['com.sun.star.office.XAnnotationEnumeration']
