...
class ExoticFileLoadException(Exception_85530a09):
    ...
    **since**
    ...
    typeName: Literal['com.sun.star.document.ExoticFileLoadException']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., URL: typing.Optional[str] = ..., FilterUIName: typing.Optional[str] = ...) -> None:
        """
        Constructor
