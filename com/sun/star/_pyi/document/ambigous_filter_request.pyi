...
class AmbigousFilterRequest(Exception_85530a09):
    ...
    typeName: Literal['com.sun.star.document.AmbigousFilterRequest']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., URL: typing.Optional[str] = ..., SelectedFilter: typing.Optional[str] = ..., DetectedFilter: typing.Optional[str] = ...) -> None:
        """
        Constructor
