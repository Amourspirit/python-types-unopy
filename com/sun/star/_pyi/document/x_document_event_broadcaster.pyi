...
class XDocumentEventBroadcaster(ABC):
    ...
    **since**
    ...
    """
    __pyunointerface__: Literal['com.sun.star.document.XDocumentEventBroadcaster']
    ...
    def addDocumentEventListener(self, Listener: 'XDocumentEventListener_7db01146') -> None:
        ...
        """
        ...
    def notifyDocumentEvent(self, EventName: str, ViewController: 'XController2_bbcf0bc1', Supplement: typing.Any) -> None:
        """
