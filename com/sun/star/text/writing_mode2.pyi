...
class WritingMode2:
    ...
    **since**
    ...
    TB_RL90: int = ...
    """
    text within a line is written top-to-bottom so as if a horizontal left-to-right line is clockwise rotated by 90deg.
    
    Lines and blocks are placed right-to-left. This corresponds to OOXML attribute vert=\"vert\" for shapes and ECMA w:val=\"tbRl\" attribute in <w:textDirection> element.
