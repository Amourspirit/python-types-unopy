...
class PackageFolderEnumeration(XEnumeration_f2180daa):
    """
    Service Class

    This service provides an iterator over the contents of a given instance of a PackageFolder.
    ...
    See Also:
        `API PackageFolderEnumeration <https://api.libreoffice.org/docs/idl/ref/servicecom_1_1sun_1_1star_1_1packages_1_1PackageFolderEnumeration.html>`_
    """
    ...
