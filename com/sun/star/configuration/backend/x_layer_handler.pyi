...
class XLayerHandler(XInterface_8f010a43):
    ...
    **since**
    ...
    def addProperty(self, aName: str, aAttributes: int, aType: typing.Any) -> None:
        ...
        """
        ...
    def addPropertyWithValue(self, aName: str, aAttributes: int, aValue: typing.Any) -> None:
        """
    ...
    def overrideNode(self, aName: str, aAttributes: int, bClear: bool) -> None:
        ...
        """
        ...
    def overrideProperty(self, aName: str, aAttributes: int, aType: typing.Any, bClear: bool) -> None:
        """
