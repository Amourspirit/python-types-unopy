...
class EmbedMisc(object):
    ...
    """
    MS_EMBED_STATIC: int = 8
    """
    The object is a static object that contains only representation.
    """
    MS_EMBED_CANTLINKINSIDE: int = 16
    MS_EMBED_CANLINKBYOLE1: int = 32
    MS_EMBED_ISLINKOBJECT: int = 64
    MS_EMBED_INSIDEOUT: int = 128
    MS_EMBED_ACTIVATEWHENVISIBLE: int = 256
    MS_EMBED_RENDERINGISDEVICEINDEPENDENT: int = 512
    MS_EMBED_INVISIBLEATRUNTIME: int = 1024
    MS_EMBED_ALWAYSRUN: int = 2048
    MS_EMBED_ACTSLIKEBUTTON: int = 4096
    MS_EMBED_ACTSLIKELABEL: int = 8192
    MS_EMBED_NOUIACTIVATE: int = 16384
    MS_EMBED_ALIGNABLE: int = 32768
    MS_EMBED_SIMPLEFRAME: int = 65536
    MS_EMBED_SETCLIENTSITEFIRST: int = 131072
    MS_EMBED_IMEMODE: int = 262144
    MS_EMBED_IGNOREACTIVATEWHENVISIBLE: int = 524288
    MS_EMBED_WANTSTOMENUMERGE: int = 1048576
    MS_EMBED_SUPPORTSMULTILEVELUNDO: int = 2097152
    EMBED_ACTIVATEIMMEDIATELY: int = 4294967296
    EMBED_NEVERRESIZE: int = 8589934592
    EMBED_NEEDSSIZEONLOAD: int = 17179869184
    """
