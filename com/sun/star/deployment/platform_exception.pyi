...
class PlatformException(Exception_85530a09):
    ...
    **since**
    ...
    typeName: Literal['com.sun.star.deployment.PlatformException']

    def __init__(self, Message: typing.Optional[str] = ..., Context: typing.Optional[XInterface_8f010a43] = ..., package: typing.Optional[XPackage_cb1f0c4d] = ...) -> None:
        """
        Constructor
