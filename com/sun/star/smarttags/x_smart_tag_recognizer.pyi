...
class XSmartTagRecognizer(XInitialization_d46c0cca):
    ...
    **since**
    ...
    def hasPropertyPage(self, nSmartTagIndex: int, aLocale: Locale_70d308fa) -> bool:
        ...
        """
        ...
    def recognize(self, aText: str, nStart: int, nLength: int, eDataType: SmartTagRecognizerModeProto, aLocale: Locale_70d308fa, xTextMarkup: XTextMarkup_a5d60b3a, aApplicationName: str, xController: XController_b00e0b8f, xTokenizer: XBreakIterator_bf270bcf) -> None:
        """
