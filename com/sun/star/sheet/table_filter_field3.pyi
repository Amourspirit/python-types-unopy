...
class TableFilterField3(object):
    ...
    **since**
    ...
    def __init__(self, Connection: typing.Optional[FilterConnection_f01f0d97] = ..., Field: typing.Optional[int] = ..., Operator: typing.Optional[int] = ..., Values: typing.Optional[typing.Tuple[FilterFieldValue_ef2a0d68, ...]] = ...) -> None:
        """
        Constructor
