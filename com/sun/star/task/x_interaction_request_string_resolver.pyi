...
class XInteractionRequestStringResolver(XInterface_8f010a43):
    ...
    """
    __pyunointerface__: str = 'com.sun.star.task.XInteractionRequestStringResolver'

    def getStringFromInformationalRequest(self, Request: XInteractionRequest_cb20e7c) -> typing.Any:
        """
