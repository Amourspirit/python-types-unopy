...
class MenuMultipleChange(object):
    ...
    def __init__(self, ID: typing.Optional[int] = ..., GroupID: typing.Optional[int] = ..., PreItemID: typing.Optional[int] = ..., ItemText: typing.Optional[str] = ..., IsVisible: typing.Optional[bool] = ..., IsActive: typing.Optional[bool] = ..., IsCheckable: typing.Optional[bool] = ..., IsChecked: typing.Optional[bool] = ..., Image: typing.Optional[typing.Tuple[int, ...]] = ...) -> None:
        """
        Constructor
