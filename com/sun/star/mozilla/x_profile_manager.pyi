...
class XProfileManager(XInterface_8f010a43):
    ...
    def bootupProfile(self, product: MozillaProductTypeProto, profileName: str) -> int:
        """
        attempts to init XPCOM runtime using given profile.
        """
        ...
    def getCurrentProduct(self) -> MozillaProductTypeProto:
        """
    ...
    def isCurrentProfileLocked(self) -> bool:
        ...
        """
        ...
    def setCurrentProfile(self, product: MozillaProductTypeProto, profileName: str) -> str:
        """
