...
class DriverPropertyInfo(object):
    ...
    def __init__(self, Name: typing.Optional[str] = ..., Description: typing.Optional[str] = ..., IsRequired: typing.Optional[bool] = ..., Value: typing.Optional[str] = ..., Choices: typing.Optional[typing.Tuple[str, ...]] = ...) -> None:
        """
        Constructor
