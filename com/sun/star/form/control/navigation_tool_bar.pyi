...
class NavigationToolBar(UnoControl_8f2c0a67):
    """
    Service Class

    This service specifies the model for control which provides controller functionality for a com.sun.star.form.component.DataForm, such as navigating or filtering the form.
