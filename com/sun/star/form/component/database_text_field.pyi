...
from .text_field import TextField as TextField_db00e46

class DatabaseTextField(DataAwareControlModel_27110ef8, TextField_db00e46):
    """
    Service Class
    ...
    See Also:
        `API DatabaseTextField <https://api.libreoffice.org/docs/idl/ref/servicecom_1_1sun_1_1star_1_1form_1_1component_1_1DatabaseTextField.html>`_
    """
    @property
    def ConvertEmptyToNull(self) -> bool:
        ...
        When the user enters text into a text field, and after this, the control content is to be committed into the database field the control is bound to, a decision must be made how to deal with empty strings.This is controlled by this property.
