...
class ListEntryEvent(EventObject_a3d70b03):
    ...
    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = ..., Position: typing.Optional[int] = ..., Count: typing.Optional[int] = ..., Entries: typing.Optional[typing.Tuple[str, ...]] = ...) -> None:
        """
        Constructor
