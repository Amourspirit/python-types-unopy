...
from ..component.database_formatted_field import DatabaseFormattedField as DatabaseFormattedField_e9c4135c

class BindableDatabaseFormattedField(BindableDataAwareControlModel_47091512, DatabaseFormattedField_e9c4135c):
    """
    Service Class

    This service specifies a formatted input field which is data-aware and thus can be bound to a database field, and additionally supports binding to arbitrary external values.
