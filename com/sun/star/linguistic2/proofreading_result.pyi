...
class ProofreadingResult(object):
    ...
    **since**
    ...
    def __init__(self, aDocumentIdentifier: typing.Optional[str] = ..., xFlatParagraph: typing.Optional[XFlatParagraph_c8310c42] = ..., aText: typing.Optional[str] = ..., aLocale: typing.Optional[Locale_70d308fa] = ..., nStartOfSentencePosition: typing.Optional[int] = ..., nBehindEndOfSentencePosition: typing.Optional[int] = ..., nStartOfNextSentencePosition: typing.Optional[int] = ..., aErrors: typing.Optional[typing.Tuple[SingleProofreadingError_c54812c1, ...]] = ..., aProperties: typing.Optional[typing.Tuple[PropertyValue_c9610c73, ...]] = ..., xProofreader: typing.Optional[XProofreader_dab0e46] = ...) -> None:
        """
        Constructor
