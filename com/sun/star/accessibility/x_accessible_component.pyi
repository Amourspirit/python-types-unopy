...
class XAccessibleComponent(XInterface_8f010a43):
    ...
    **since**
    ...
    def getAccessibleAtPoint(self, Point: Point_5fb2085e) -> XAccessible_1cbc0eb6:
        ...
        The test point's coordinates are defined relative to the coordinate system of the object. That means that when the object is an opaque rectangle then both the points (0,0) and (width-1,height-1) are points inside of the object.
        """
        ...
