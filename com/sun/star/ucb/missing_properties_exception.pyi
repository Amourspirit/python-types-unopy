...
class MissingPropertiesException(Exception_85530a09):
    ...
    For example, to create a new resource, usually one or more property values must be set prior to executing the command \"insert\", which makes the new resource persistent.
