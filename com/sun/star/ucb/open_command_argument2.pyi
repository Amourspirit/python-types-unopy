...
class OpenCommandArgument2(OpenCommandArgument_fb0a0dd6):
    ...
    def __init__(self, Mode: typing.Optional[int] = ..., Priority: typing.Optional[int] = ..., Sink: typing.Optional[XInterface_8f010a43] = ..., Properties: typing.Optional[typing.Tuple[Property_8f4e0a76, ...]] = ..., SortingInfo: typing.Optional[typing.Tuple[NumberedSortingInfo_fd0e0de6, ...]] = ...) -> None:
        """
        Constructor
